...
public final class CMTestDirectories
{
  private static final Logger LOGGER =
    LoggerFactory.getLogger(CMTestDirectories.class);

  private CMTestDirectories()
  {
    ...
    throws IOException
  {
    ...
    final var path = Path.of(property).resolve("canonmill");
  ...
  public static Path resourceOf(
    ...
    throws IOException
  {
    final var internal = String.format("/com/io7m/canonmill/tests/%s", name);
